...
export var Hash = {
   ...
   */
  sha1: <{blocksize: number}&((Buffer)=>Buffer)> function (buf: Buffer): Buffer {
   ...
   * @returns {Buffer} The hash in the form of a buffer.
   */
  sha256: <{blocksize: number}&((Buffer)=>Buffer)>function (buf:Buffer): Buffer {
    $.checkArgument(Buffer.isBuffer(buf))
   ...
   * @returns {Buffer} The hash in the form of a buffer.
   */
  sha256sha256: function (buf: Buffer): Buffer {
    $.checkArgument(Buffer.isBuffer(buf))
   ...
   * @returns {Buffer} The hash in the form of a buffer.
   */
  ripemd160: function (buf: Buffer): Buffer {
    $.checkArgument(Buffer.isBuffer(buf))
   ...
   * @returns {Buffer} The hash in the form of a buffer.
   */
  sha256ripemd160: function (buf: Buffer): Buffer {
    $.checkArgument(Buffer.isBuffer(buf))
   ...
   * @returns {Buffer} The hash in the form of a buffer.
   */
  sha512: <{blocksize: number}&((Buffer)=>Buffer)> function (buf: Buffer): Buffer {
    $.checkArgument(Buffer.isBuffer(buf))
