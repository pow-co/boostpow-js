...
describe("boost #BoostPowString tryValidateJobProof", () => {
  it("tryValidateJobProof success sample test_decode", async () => {
    const job = index.BoostPowJob.fromTransaction(
      ...
      "3cfe6c474445cd503b1397c25368e9bfffffffff090000000000000000fdcc01006a22" +
      "31394878696756345179427633744870515663554551797131707a5a56646f4175740e" +
      "237269736b202366696e616e63650a746578742f706c61696e04746578741f74776574" +
      "63685f7477746578745f313630313535323531393137312e747874017c223150755161" +
      "374b36324d694b43747373534c4b79316b683536575755374d74555235035345540b74" +
      "77646174615f6a736f6e046e756c6c0375726c046e756c6c07636f6d6d656e74046e75" +
      "6c6c076d625f7573657203353233057265706c79046e756c6c047479706504706f7374" +
      "0974696d657374616d70046e756c6c036170700674776574636807696e766f69636524" +
      "64396564613934312d346666312d343336652d626362302d3030353532383638613361" +
      "61017c22313550636948473232534e4c514a584d6f5355615756693757537163376843" +
      "", 6)
...
describe("boost #BoostPowJob createRedeemTransaction", () => {
  it("createRedeemTransaction success", async () => {
    ...
    const job = index.BoostPowJob.fromTransaction(tx_job)
    ...
    let tx = index.BoostPowJob.createRedeemTransaction(
      ...
      "1264UeZnzrjrMdYn1QSED5TCbY8Gd11e23", sats_per_byte
    ).toBuffer()

    let fee = index.bsv.Transaction(tx_job).toJSON().outputs[0].satoshis - index.bsv.Transaction(tx).toJSON().outputs[0].satoshis
...
describe("BoostPowJob", () => {
  it("should correctly set txid if provided from all loaders", async () => {
    let job
    job = index.BoostPowJob.fromTransaction(sampleTx1)
